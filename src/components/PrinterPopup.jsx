...
const PrinterPopup = ({
  ...
  const showHeaderWarning = !CALM_COLORS.map(c => c.toLowerCase()).includes(color.toLowerCase());

  return (
    <div className="w-[300px] font-barlow">
      ...
      {/* Status bar */}
      <div className="w-full box-border bg-[#e0e0e0] px-[12.5px] py-[7.5px] text-[1.125rem] text-[#555] italic">
        {statusSummary}
      </div>

      {/* Body */}
      <div className="bg-[#f5f5f5] rounded-b-[0.625rem] px-[15px] py-[12.5px] text-[1.125rem] text-[#222] flex flex-col gap-[10px]">
